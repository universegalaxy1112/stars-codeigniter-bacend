...
class Base_Model extends CI_Model
{
    ...
    private function _fetch_table()
    {
        if ($this->_table == NULL)
        {
            ...
            } else if( $this->endsWith( $class_name, 'z_m' ) || $this->endsWith( $class_name, 'z_model' ) ){
                $this->_table = preg_replace('/(z_m|z_model)?$/', '', $class_name).'zzes';
            } else if( $this->endsWith( $class_name, 'ss_m' ) || $this->endsWith( $class_name, 'ss_model' ) ){
                $this->_table = preg_replace('/(_m|_model)?$/', '', $class_name).'sses';
